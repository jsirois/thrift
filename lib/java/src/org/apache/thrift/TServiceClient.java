...
public abstract class TServiceClient {
  ...
  protected void sendBase(String methodName, TImmutableBase<?, ?> args) throws TException {
    sendBase(methodName, args, TMessageType.CALL);
  }

  protected void sendBaseOneway(String methodName, TImmutableBase<?, ?> args) throws TException {
    sendBase(methodName, args, TMessageType.ONEWAY);
  }

  private void sendBase(String methodName, TImmutableBase<?, ?> args, byte type) throws TException {
